...
const CardList: React.FC = () => {
  ...
  //format market capture to display in millions, billions, trillions
    ...
    >
      ...
      >
        ...
        <InputGroup width="100%" marginBottom="4">
          <Input
            type="text"
            placeholder="Track your favorite crypto assets"
            variant="filled"
          ...
          <InputRightElement width="4.5rem">
            ...
            <SearchIcon color="gray.500" position="absolute" right="0.5rem" />
          </InputRightElement>
        </InputGroup>
        {/* Header */}
        <Flex
